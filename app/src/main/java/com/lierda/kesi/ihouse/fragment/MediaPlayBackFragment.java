...
import com.lierda.kesi.ihouse.constants.RecoderSeekBar;
...
//		}		
	...
	public void play(int strRes) {
		...
		if (recordInfo.getType() == RecordInfo.RecordType.PublicCloud){
			mPlayWin.playCloud(Business.getInstance().getToken(), channelInfo.getDeviceCode(), channelInfo.getEncryptKey() != null ? channelInfo.getEncryptKey() : channelInfo.getDeviceCode(), recordInfo.getRecordID(), 0, 24 * 3600);
		}else{
			...
			mPlayWin.playRtspPlaybackByFileName(Business.getInstance().getToken(), channelInfo.getDeviceCode(), channelInfo.getEncryptKey() != null ? channelInfo.getEncryptKey() : channelInfo.getDeviceCode(), recordInfo.getRecordPath());
		}
