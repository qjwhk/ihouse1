	...
	class AlarmMsgListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
				...
				holder.photo.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						if(holder.info.getPicUrl() != null && holder.info.getPicUrl().length() > 0)
							ImageHelper.loadRealImage(holder.info.getPicUrl(), holder.info.getDeviceKey() != null ? holder.info.getDeviceKey() : holder.info.getDeviceId(), new Handler(){
								@Override
								public void handleMessage(Message msg) {
			...
			if(holder.info.getThumbUrl() != null && holder.info.getThumbUrl().length() > 0)
				ImageHelper.loadCacheImage(holder.info.getThumbUrl(),holder.info.getDeviceKey() != null ? holder.info.getDeviceKey() : holder.info.getDeviceId(), new Handler(){
					@Override
					public void handleMessage(Message msg) {
						super.handleMessage(msg);
